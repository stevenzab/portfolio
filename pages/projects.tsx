  ...
  const projects = [
    {
      ...
      description: "Site vitrine responsive développé avec Next.js, TypeScript et Tailwind CSS. Interface moderne avec animations fluides et optimisation SEO.",
    ...
    },
    {
      ...
      technologies: ["C#", ".NET 8", "SQL Server", "Angular"],
      features: [
    ...
    },
    {
      ...
      technologies: ["React", "Figma", "SCSS", "Jest"],
      features: [
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {projects.map((project) => (
            <div key={project.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300">
              {/* Image du projet */}
              <div className={`bg-gradient-to-r ${getGradientClass(project.image)} h-48 flex items-center justify-center relative`}>
        ...
        <div className="text-center mt-16">
          <div className="bg-white rounded-2xl shadow-lg p-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a 
                href="#" 
                className="bg-gray-900 hover:bg-gray-800 text-white px-6 py-3 rounded-lg font-semibold transition flex items-center gap-2"
              >
